...
def dark_modern(prs, slides_content):
    ...
    for slide_content in slides_content:
        if count < first:
            ...
            slide_format(content_frame, 36, 'Lato', 255, 255, 255, 0, 30)
            ...
            slide_format(title_frame, 50, 'Montserrat', 114, 222, 173, 0, 0)
            slide_format(content_frame, 36, 'Lato', 255, 255, 255, 0, 35)
            ...
            content_box = slide.shapes.add_textbox(Inches(0.9), Inches(3.13), Inches(9.71), Inches(7))
            title_box.text = slide_content['title']
            content_box.text = slide_content['content']
