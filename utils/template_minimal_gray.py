...
def minimal_gray(prs, slides_content):
    ...
    for slide_content in slides_content:
        if count < first:
            ...
            slide_format(title_frame, 50, 'Bahnschrift SemiBold', 0, 0, 0, 0, 0)
            slide_format(content_frame, 32, 'Bahnschrift', 5, 0, 0, 0, 16)
            ...
            slide_format(title_frame, 50, 'Bahnschrift SemiBoldi', 0, 0, 0, 0, 0)
            slide_format(content_frame, 32, 'Bahnschrift', 0, 0, 0, 0, 20)
            ...
            slide_format(title_frame, 50, 'Bahnschrift SemiBold', 0, 0, 0, 0, 0)
            slide_format(content_frame, 32, 'Bahnschrift', 0, 0, 0, 0, 25)
        else:
            slide = prs.slides.add_slide(prs.slide_layouts[6])
            # file_path = os.path.join('static', 'pictures', '4.png')
            image_url = search_pexels_images(slide_content['title'])
            ...
            slide_format(title_frame, 50, 'Bahnschrift SemiBold', 0, 0, 0, 0, 0)
            slide_format(content_frame, 32, 'Bahnschrift', 0, 0, 0, 0, 16)
        count += 1


def update_minimal_gray(prs, file_path, auto, hasPicture, slide_content, slideNum):
