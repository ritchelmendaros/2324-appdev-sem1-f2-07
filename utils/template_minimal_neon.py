...
def minimal_neon(prs, slides_content):
    ...
    for slide_content in slides_content:
        if count < first:
            ...
            slide_format(title_frame, 50, 'Franklin Gothic Demi', 0, 0, 0, 0, 0)
...
def update_minimal_neon(prs, file_path, auto, hasPicture, slide_content, slideNum):
