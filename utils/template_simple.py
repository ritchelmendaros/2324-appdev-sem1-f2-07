...
def simple(prs, slides_content):
    ...
    for slide_content in slides_content:
        if count < first:
            ...
            slide_format(content_frame, 36, 'Bahnschrift', 5, 14, 56, 0, 30)
...
def update_simple(prs, file_path, auto, hasPicture, slide_content, slideNum):
